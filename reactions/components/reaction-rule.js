...
import { Datagrid, TextField, Create, Edit, SimpleForm, TextInput, SelectInput, DateInput, DateField, EditButton, DeleteButton, List, NumberInput } from 'admin-on-rest'
...
export const ReactionRuleCreate = (props) => (
  <Create {...props} title="Create a reaction rule">
    <SimpleForm>
      ...
      <DateInput label='Closing date' source='closingDate' defaultValue={minClosingDate()} options={{ minDate: minClosingDate() }} />
    </SimpleForm>
  </Create>
)
