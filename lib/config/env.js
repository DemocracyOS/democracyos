...
module.exports = {
  ...
  faq: env.FAQ ? !!~on.indexOf(env.FAQ.toLowerCase()) || !!env.FAQ : null,
  tos: env.TERMS_OF_SERVICE ? !!~on.indexOf(env.TERMS_OF_SERVICE.toLowerCase()) || !!env.TERMS_OF_SERVICE : null,
  pp: env.PRIVACY_POLICY ? !!~on.indexOf(env.PRIVACY_POLICY.toLowerCase()) || !!env.PRIVACY_POLICY : null,
  glossary: env.GLOSSARY ? !!~on.indexOf(env.GLOSSARY.toLowerCase()) || !!env.GLOSSARY : null
};