...
module.exports = {
  ...
  "faq enabled": env.FAQ_ENABLED || false,
  "tos enabled": env.TERMS_OF_SERVICE_ENABLED || false,
  "pp enabled": env.PRIVACY_POLICY_ENABLED || false,
  "glossary enabled": env.GLOSSARY_ENABLED || false
};