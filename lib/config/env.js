...
module.exports = {
  ...
  "faq": env.FAQ ? ~on.indexOf(env.FAQ.toLoweCase()) : false,
  "tos": env.TERMS_OF_SERVICE ? ~on.indexOf(env.TERMS_OF_SERVICE.toLoweCase()) : false,
  "pp": env.PRIVACY_POLICY ? ~on.indexOf(env.PRIVACY_POLICY.toLoweCase()) : false,
  "glossary": env.GLOSSARY ? ~on.indexOf(env.GLOSSARY.toLoweCase()) : false
};