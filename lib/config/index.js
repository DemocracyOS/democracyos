...
var normalizeEmail = require('lib/normalize-email/normalize-email');
...
config.staff.forEach(function(email, index){
  config.staff[index] = normalizeEmail(config.staff[index], {
