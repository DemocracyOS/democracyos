...
app.post('/forum/:id/permissions', restrict, forum, restrictPermissions, function (req, res, next) {
  api.forum.grantPermission(req.params.id, req.body.user, req.body.role)
  .then(forum => res.status(200).send(forum))
  .catch(err => res.status(500).send(err));
});

app.delete('/forum/:id/permissions', restrict, forum, restrictPermissions, function (req, res, next) {
