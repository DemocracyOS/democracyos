...
CommentsEditView.prototype.switchOn = function() {
  ...
  this.on('put', this.onsuccess.bind(this));
};
...
CommentsEditView.prototype.put = function(data) {
  ...
  .end(function(err, res) {
    ...
    view.emit('put', res.body);
  });
}

/**
 * On success editing a comment
 *
 * @param {Object} data
 * @api public
 */

CommentsEditView.prototype.onsuccess = function(data) {
...
CommentsEditView.prototype.hide = function() {
