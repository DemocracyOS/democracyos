...
TopicSchema.methods.vote = function (user, value, cb) {
  if (this.closed) return cb(new Error('Voting is closed.'))
...
TopicSchema.methods.poll = function (user, value, cb) {
  if (this.closed) return cb(new Error('Polling is closed.'))
...
TopicSchema.methods.support = function (user, cb) {
  if (this.closed) return cb(new Error('Supporting is closed.'))
