...
var commentValidator = [
    { validator: minTextValidator, msg: 'Comment cannot be empty' }
  , { validator: maxTextValidator, msg: 'Comment is limited to 2048 characters' }
]
...
var CommentSchema = new Schema({
    author:     { type: ObjectId, required: true, ref: 'Citizen' }
  , text:       { type: String, validate: commentValidator, trim: true, required: true }
