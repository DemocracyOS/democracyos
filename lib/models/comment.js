...
CommentSchema.post('save', function (comment) {
  if (this.context !== 'body' && this.context !== 'clause') {
...
/**
 * Default find Method override, to be used in favor of .find()
 *
 * @api public
 */

CommentSchema.static('findDefault', function findDefault (query) {
  return this.find(Object.assign(defaultQuery, query))
})

/**
 * Default findOne Method override, to be used in favor of .findOne()
 *
 * @api public
 */

CommentSchema.static('findOneDefault', function findOneDefault (query) {
  return this.findOne(Object.assign(defaultQuery, query))
})
