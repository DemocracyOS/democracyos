...
/**
 * Define `ClauseComment` Schema
 */

var ClauseCommentSchema = new Schema({
    author: { type: ObjectId, ref: 'Citizen', required: true }
...
ClauseCommentSchema.index({ createdAt: -1 });

mongoose.model('ClauseComment', ClauseCommentSchema);
