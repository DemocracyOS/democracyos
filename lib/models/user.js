...
UserSchema.plugin(passportLocalMongoose, {
  usernameField: 'email',
  attemptTooSoonError: t('signin.errors.too-many-attempts'),
  tooManyAttemptsError: t('signin.errors.attempt-too-soon'),
  incorrectPasswordError: t('signin.errors.incorrect-password'),
  incorrectUsernameError: t('signin.errors.incorrect-username')
})
