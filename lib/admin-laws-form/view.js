...
LawForm.prototype.onremovelinkclick = function(ev) {
  ...
  confirm(t('admin-laws-form.link.confirmation.title'), t('admin-laws-form.link.confirmation.body'))
  .cancel(t('admin-laws-form.link.confirmation.cancel'))
  .ok(t('admin-laws-form.link.confirmation.ok'))
  .modal()
  .closable()
  .effect('slide')
  .focus()
