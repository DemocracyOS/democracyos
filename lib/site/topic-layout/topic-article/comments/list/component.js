                ...
                </button>
                {
                  ...
                  (
                    <div
                      ...
                      <button onClick={this.toggleDeleteConfirmation}>
          ...
          commentsReplying={this.props.commentsReplying} />
        {
          this.state.deleteConfirmationVisibility && (
            <div className='delete-comment-confirmation'>
              ...
              <footer>
                <button onClick={this.toggleDeleteConfirmation} className='btn btn-sm btn-default'>{t('common.cancel')}</button>
                <button onClick={this.handleDelete} className='btn btn-sm btn-danger'>{t('common.ok')}</button>
              </footer>
            </div>
          )
        }
