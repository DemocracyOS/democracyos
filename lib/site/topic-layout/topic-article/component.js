    ...
    return (
      <div className='topic-article-wrapper'>
        ...
        <Header
          ...
          {
            this.props.forum.privileges.canCreateTopics &&
            this.props.topic.privileges.canEdit &&
              <a href={`/${this.props.forum.name}/admin/topics/${this.props.topic.id}`} className='edit-topic btn btn-default btn-sm'>Editar propuesta</a>
          }
        </ Header>
