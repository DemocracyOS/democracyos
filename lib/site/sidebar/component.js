...
export default class Sidebar extends Component {
  ...
  filterStatusChange (e) {
    let status = e.target.getAttribute('data-status') === 'open'
  ...
  filterTopics () {
    ...
    let topicsDisplay = topics
        ...
        // Sort
        .sort(sorts[this.state.filterCurrentSort])

    this.setState({topicsDisplay: topicsDisplay})
  }
