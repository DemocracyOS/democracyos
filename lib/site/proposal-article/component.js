      ...
      <div className="inner-container">
        ...
        <article className="proposal commentable-container">
          ...
          <div className="share-links">
            <a href={'http://www.facebook.com/sharer.php?u=' + window.location.origin + this.props.proposal.url} target="_blank" className='flaticon social facebook'></a>
            <a href={'http://twitter.com/share?text=' + (config.tweetText || this.props.proposal.mediaTitle) + '&url=' + window.location.origin + this.props.proposal.url} className="flaticon social twitter" target="_blank"></a>
          </div>
        </article>
      </div>
    )
