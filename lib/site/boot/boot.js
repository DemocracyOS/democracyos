...
import RestrictNotLogged from 'lib/site/wrappers/restrict-not-logged'
...
render((
  <Router history={browserHistory} onUpdate={track}>
    <Route path='/' component={Layout}>
      ...
      <Route path='signin' component={RestrictNotLogged(SignIn)} />

      <Route path='signup'>
        <IndexRoute component={RestrictNotLogged(SignUp)} />
        <Route path='resend-validation-email' component={RestrictNotLogged(Resend)} />
        <Route path='validate/:token' component={RestrictNotLogged(Resend)} />
        <Route path=':reference' component={RestrictNotLogged(SignUp)} />
      </Route>

      <Route path='forgot'>
        <IndexRoute component={RestrictNotLogged(Forgot)} />
        <Route path=':token' component={RestrictNotLogged(Reset)} />
      </Route>
