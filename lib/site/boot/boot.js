...
const forumNameParam = config.multiForum ? ':forumName' : null
...
render((
  <Router history={browserHistory} onUpdate={track}>
    <Route path='/' component={Layout}>
      ...
      <Route path={forumNameParam} onEnter={setForumName}>
...
function setForumName (nextState) {
  if (!config.multiForum) {
    nextState.params.forumName = config.defaultForum
  }
}
