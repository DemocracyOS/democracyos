...
export default class UserBadge extends Component {
  ...
  componentDidMount () {
    // document.body.addEventListener('click', this.closeMenuClickOut.bind(this))
    bus.on('forum:change', this.setChangeTopicsPermission.bind(this))
  }

  componentWillUnmount () {
    // document.body.removeEventListener('click', this.closeMenuClickOut.bind(this))
    bus.off('forum:change', this.setChangeTopicsPermission.bind(this))
  }
