...
export default class UserBadge extends Component {
  ...
  setChangeTopicsPermission (forum) {
    console.log('setChangeTopicsPermission', forum, forum.privileges.canChangeTopics)
  ...
  render () {
    var menuItemAdmin
    console.log(config.multiForum, this.props.user.privileges, this.props.user.privileges.canManage)
