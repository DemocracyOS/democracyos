...
app.get('/tag/all', function (req, res) {
  ...
  api.tag.all(function (err, tags) {
    if (err) return _hangleError(err, req, res);
...
app.post('/tag/create', restrict, staff, function (req, res, next) {
...
app.post('/tag/:id', restrict, staff, function (req, res) {
