...
exports.expose.confidential = function(user){
  return expose('id firstName lastName email gravatar() staff profilePictureUrl notifications locale')(user);
}
...
exports.expose.ordinary = function(user){
  return expose('id fullName gravatar() profilePictureUrl notifications locale')(user);
}
