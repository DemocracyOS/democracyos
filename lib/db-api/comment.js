...
exports.getSideComments = function getSideComments (topicId, paging, fn) {
  ...
  Comment
    ...
    .exec(function (err, comments) {
      ...
      var opts = { path: 'author', select: 'id firstName lastName fullName email avatar profilePictureUrl' };
...
exports.replies = function replies(id, fn) {
  ...
  .exec(function(err, comment) {
    ...
    var opts = { path: 'replies.author', select: 'id firstName lastName fullName email avatar profilePictureUrl' };
    ...
    comment.save(function(err, saved) {
      ...
      User.populate(comment, opts, function(err, comment) {
        ...
        if (comment.author != reply.author.id) {
          ...
          var topicUrl = utils.buildUrl(config, { pathname: '/topic/' + comment.reference });
