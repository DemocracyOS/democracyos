 ...
 * Get all laws
 *
 * @param {Object} find query object
...
exports.all = function all(find, fn) {
  ...
  Law
  .find(find)
  .select('id lawId mediaTitle tag participants votes createdAt updatedAt closingAt publishedAt deletedAt status open closed')
