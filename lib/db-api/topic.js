...
exports.all = function all(params, fn) {
  ...
  Topic
  .find(query)
  .select('id topicId mediaTitle participants votes createdAt updatedAt closingAt publishedAt deletedAt status open closed links author authorUrl forum')
...
exports.create = function create(data, fn) {
  ...
  topic.save(function onsave(err) {
...
exports.update = function update(id, data, fn) {
  ...
  // get topic
  exports.get(id, function onget(err, topic) {
    if (err) {
    ...
    topic.set(data);
    topic.save(function onupdate(err, topic) {
      if (err) {
