...
View.prototype.onfilterready = function() {
  var sarasa = o('#filter-container', this.el);
  filter.render(sarasa);
  list.ready(this.onlistready.bind(this));
};

View.prototype.onlistready = function() {
...
View.prototype.items = function(index) {
