...
export class Dropdown {
  ...
  show () {
    console.log('show', this.input)
    if (this._toggling) return this
    this._toggling = true
  ...
  bindShowEvents (bind = true) {
    ...
    bean[action](this.el, 'mouseleave', '*', this.onItemMouseleave)
  }

  hide () {
    console.log('hide', this.input)
    if (this._toggling) return this
    this._toggling = true
    if (!this.showing) return this
...
export class DropdownTemplate extends Dropdown {
  render () {
...
export class DropdownInput extends DropdownTemplate {
  constructor (options = {}) {
    super(options)
