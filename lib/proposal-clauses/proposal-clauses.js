...
//import SideComments from 'side-comments'; //fixme
import View from '../view/view.js';
import template from './template.jade';

let log = debug('democracyos:proposal-clause');
let SideComments = () => true; //fixme
export default class ProposalClauses extends View {
  ...
  sideComments  () {
    ...
    let userComment = citizen.id ? {
      id: citizen.id,
      avatarUrl: citizen.profilePictureUrl ? citizen.profilePictureUrl : citizen.gravatar,
    ...
    let sideComments = self.sideComments = new SideComments('.commentable-container', userComment, sections, { trans: t, locale: config.locale });
