...
ProposalClauses.prototype.sideComments = function () {
  var self = this;
  var userComment = citizen.id ? { id: citizen.id, avatarUrl: citizen.profilePictureUrl ? citizen.profilePictureUrl : citizen.gravatar, name: citizen.firstName + ' ' + citizen.lastName } : null;
  var sections = [];
  var law = this.law;
