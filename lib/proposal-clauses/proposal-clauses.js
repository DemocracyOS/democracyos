...
ProposalClauses.prototype.sideComments = function () {
  var self = this;
  var userComment = citizen.id ? { id: citizen.id, avatarUrl: citizen.gravatar, name: citizen.firstName} : null;
  var sections = [];
  ...
  var sideComments = self.sideComments = new SideComments('.commentable-container', userComment, sections, { locale: config['locale'], voting: true });
