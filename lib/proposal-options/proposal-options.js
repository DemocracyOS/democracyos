...
function ProposalOptions (proposal, citizen) {
  ...
  this.buttonsBox = this.el.querySelector('.vote-box .vote-options');
  this.delegationBox = this.el.querySelector('.vote-box .delegation-box');

  this.delegationInput = this.el.querySelector('.vote-box .delegation-box .delegation-input');
...
ProposalOptions.prototype.vote = function(ev) {
  ...
  if (this.citizen.id) {
    ...
    classes(this.el.querySelector('.proposal-options p.text-mute.hide')).remove('hide');
  }
...
ProposalOptions.prototype.renderChart = function() {
  var container = this.el.querySelector('#results-chart');
  var census = this.proposal.votes;
