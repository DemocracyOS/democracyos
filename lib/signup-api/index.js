...
var whitelisted = require('lib/db-api')['whitelisted-user'];
...
app.post('/', function(req, res, next) {
  ...
  whitelisted(req.body.email, function (err, user) {
    ...
    if (user) {
      ...
      var err = new Error('Not whitelisted');
