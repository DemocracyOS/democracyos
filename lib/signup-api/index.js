...
app.post('/', authFacebookRestrict, authGitlabRestrict, function(req, res) {
  var meta = {
    ip: req.ip,
    ips: req.ips,
    host: req.get('host'),
...
app.post('/validate', authFacebookRestrict, authGitlabRestrict, function(req, res) {
...
app.post('/resend-validation-email', authFacebookRestrict, authGitlabRestrict, function(req, res) {
  var meta = {
    ip: req.ip,
    ips: req.ips,
    host: req.get('host'),
