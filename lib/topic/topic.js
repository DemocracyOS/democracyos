...
import { findTopic, findPublicTopicsSorted } from '../topic-middlewares/topic-middlewares';
...
page(forumRouter('/topic/:id'), user.optional, findForum, findPublicTopicsSorted, findTopic, (ctx, next) => {
  ...
  function pagechange(url) {
    ...
    if (/^\/$/.test(url) && !config.multiForum) return;
